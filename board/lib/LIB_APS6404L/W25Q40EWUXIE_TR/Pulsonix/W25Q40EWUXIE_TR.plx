...
(library Library_1
	...
	(symbolDef "W25Q40EWUXIE_TR" (originalName "W25Q40EWUXIE_TR")
		...
		(pin (pinNum 5) (pt 900 mils -1000 mils) (rotation 90) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 925 mils -770 mils) (rotation 90]) (justify "Left") (textStyleRef "Normal"))
		))
	...
	(compDef "W25Q40EWUXIE_TR" (originalName "W25Q40EWUXIE_TR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(attr "<Hyperlink>" "https://www.winbond.com/resource-files/w25q40ewrevf11252015sfdp.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "W25Q40EWUXIE_TR.stp")
