...
(library Library_1
	...
	(compDef "W25Q128JVSIQ_TR" (originalName "W25Q128JVSIQ_TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix L)
		...
		(compPin "7" (pinName "IO") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.winbond.com/resource-files/w25q128jv%20spi%20revc%2011162016.pdf")
		(attr "Height" "1.95 mm")
	)
